...
//Not Yet
void
PriorityLrfuPolicy::doBeforeErase(EntryRef i)
{
...
void
PriorityLrfuPolicy::doAfterRefresh(EntryRef i)
{
...
void
PriorityLrfuPolicy::doAfterInsert(EntryRef i)
{
...
void
PriorityLrfuPolicy::doBeforeUse(EntryRef i)
{
...
void
PriorityLrfuPolicy::attachQueue(EntryRef i)
{
...
void
PriorityLrfuPolicy::detachQueue(EntryRef i)
{
  BOOST_ASSERT(m_entryInfoMap.find(i) != m_entryInfoMap.end());
...
void
PriorityLrfuPolicy::updateCRF(EntryRef i)
{
  BOOST_ASSERT(m_entryInfoMap.find(i) != m_entryInfoMap.end());
...
void
PriorityLrfuPolicy::moveToLinkedList(EntryRef i)
{
    EntryInfo* entryInfo = m_entryInfoMap[i];
...
void
PriorityLrfuPolicy::moveToHeapList(EntryRef i)
{
    EntryInfo* entryInfo = m_entryInfoMap[i];
