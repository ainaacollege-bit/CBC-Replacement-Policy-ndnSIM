...
#include "ns3/ndnSIM/NFD/daemon/table/cs-policy-cbc.hpp"
#include "ns3/ndnSIM/NFD/daemon/table/cs-policy-lrfu.hpp"
#include "ns3/ndnSIM/NFD/daemon/table/cs-policy-pfr.hpp"
  ...
  , m_needSetDefaultRoutes(false)
{
  ...
  m_csPolicies.insert({"nfd::cs::cbc", [] () { return make_unique<nfd::cs::CbcPolicy>(); }});
  m_csPolicies.insert({"nfd::cs::lrfu", [] () { return make_unique<nfd::cs::PriorityLrfuPolicy>(); }});
  m_csPolicies.insert({"nfd::cs::pfr", [] () { return make_unique<nfd::cs::PfrPolicy>(); }});
